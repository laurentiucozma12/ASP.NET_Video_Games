...
using MyVideoGameProject.Data;
using VideoGameModel.Data;
using Microsoft.AspNetCore.Identity;
using MyVideoGameProject.Hubs;
...
builder.Services.AddDbContext<VideoGameContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
